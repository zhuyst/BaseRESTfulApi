package indi.zhuyst.base.security.enums;
...
/**
 * 用户状态枚举类
 * @see indi.zhuyst.base.modules.entity.UserDO#status
 * @author zhuyst
 */
public enum StatusEnum {
    ...
    /**
     * 通过ID获取枚举类
     * @param id 状态ID {@link indi.zhuyst.base.modules.entity.UserDO#status}
     * @return 枚举类
     */
    @JsonCreator
