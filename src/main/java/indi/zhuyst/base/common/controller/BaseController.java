...
public abstract class BaseController {
    ...
    /**
     * 需要授权后才能使用
     * @see indi.zhuyst.base.security.annotation.LoginAuthorize
     * @see ApiOperation#notes()
     */
     ...
     * @see indi.zhuyst.base.security.annotation.SelfAuthorize
     * @see ApiOperation#notes()
     */
    ...
    /**
     * 需要系统管理员或管理员权限
     * @see indi.zhuyst.base.security.annotation.AdminAuthorize
     * @see ApiOperation#notes()
     */
    ...
    /**
     * 需要系统管理员权限
     * @see indi.zhuyst.base.security.annotation.SysAdminAuthorize
     * @see ApiOperation#notes()
     */
     ...
     * NULL - 错误，{@link indi.zhuyst.base.common.enums.CodeEnum#ERROR}
     * NOT NULL - 成功，{@link indi.zhuyst.base.common.enums.CodeEnum#SUCCESS}
     * @param pojo 要判断的pojo
     * @param errorMsg 错误信息
     * @param <T> 对象类型
     * @return 结果对象
    ...
    /**
     * 通过判断是否成功，生成结果对象
     * TRUE - 成功，{@link indi.zhuyst.base.common.enums.CodeEnum#SUCCESS}
     * FALSE - 错误，{@link indi.zhuyst.base.common.enums.CodeEnum#ERROR}
